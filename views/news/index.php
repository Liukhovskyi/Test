...
<div id="wrapper">
	<div id="header-wrapper">
		<div id="header">
			<div id="logo">
				<h1><a href="#">simple  dynamic  site </a></h1>
				<p>MVC Каркас</p>
			</div>
		</div>
	</div>
			...
			<div id="page-bgbtm">
				<div id="content">
					...
					<div class="post">
						...
						<div class="entry">
							<p><img src="/template/images/<?php echo $newsItem['preview'];?>" width="400" height="300" alt="" /></p>
...
<div id="footer">
	<p>Yaroslav Liukhovskyi 2019. <a href="#">YarikL12@ukr.net</a></p>
</div>
<!-- end #footer -->
</body>
</html>
